...
<head>
   ...
   <link rel="icon" href="favicon.ico" type="image/ico" />
    ...
    <title>Blog Single Fullwidth</title>
</head>
<body>
        ...
        <div class="blog-content blog-content-fullwidth">
            <div class="container">
                <div class="blog-post-content full-width">
                    ...
                    <div class="blog-post">
                        <div class="area-img">
                            <img class="img-responsive" src="images/shutterstock-fullwidth.jpg" alt="">
                            <div class="blog-text">
                                <div class="category">
                                    <a href="#" class="bnt text-regular">Community</a>
                                </div>
                                <div class="article-title">
                                    <h2 class="text-regular text-capitalize">Engaging With the Sayidan Alumni Community</h2>
                                </div>
                        </div>
