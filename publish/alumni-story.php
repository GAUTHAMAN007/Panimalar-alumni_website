                    ...
                    <div class="col-sm-6 col-xs-12 pull-right">
                        <div class="interview-wrapper">
                            ...
                            <div class="interview-see-story animated zoomInLeft">
                                <a class="see-story bnt text-uppercase" href="./story-single.php">SEE HANNAH STORY</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <div class="alumni-story-wrapper">
                            <div class="alumni-story-img">
                                <img class="img-responsive" src="images/story-img1.jpg" alt="">
                            </div>
                            <div class="alumni-story-content">
                                <h3 class="heading-regular"><a href="#">Julie Scott : In Mind And Heart, Never Far From Home</a></h3>
                                <p class="text-light">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum.</p>
                                <span class="dates text-light">April 30, 2016</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <div class="alumni-story-wrapper">
                            <div class="alumni-story-img">
                                <img class="img-responsive" src="images/story-img2.jpg" alt="">
                            </div>
                            <div class="alumni-story-content">
                                <h3 class="heading-regular"><a href="#">Julie Scott : In Mind And Heart, Never Far From Home</a></h3>
                                <p class="text-light">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum.</p>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="alumni-story-wrapper">
                            <div class="alumni-story-img">
                                <img class="img-responsive" src="images/story-img3.jpg" alt="">
                            </div>
                            <div class="alumni-story-content">
                                <h3 class="heading-regular"><a href="#">Julie Scott : In Mind And Heart, Never Far From Home</a></h3>
                                <p class="text-light">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum.</p>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="alumni-story-wrapper">
                            <div class="alumni-story-img">
                                <img class="img-responsive" src="images/story-img4.jpg" alt="">
                            </div>
                            <div class="alumni-story-content">
                                <h3 class="heading-regular"><a href="#">Julie Scott : In Mind And Heart, Never Far From Home</a></h3>
                                <p class="text-light">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum.</p>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="alumni-story-wrapper">
                            <div class="alumni-story-img">
                                <img class="img-responsive" src="images/story-img5.jpg" alt="">
                            </div>
                            <div class="alumni-story-content">
                                <h3 class="heading-regular"><a href="#">Julie Scott : In Mind And Heart, Never Far From Home</a></h3>
                                <p class="text-light">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum.</p>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="alumni-story-wrapper">
                            <div class="alumni-story-img">
                                <img class="img-responsive" src="images/story-img6.jpg" alt="">
                            </div>
                            <div class="alumni-story-content">
                                <h3 class="heading-regular"><a href="#">Julie Scott : In Mind And Heart, Never Far From Home</a></h3>
                                <p class="text-light">Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum.</p>
