    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="access-denied text-center">
                <img src="images/clock-access.png" alt="">
                <h2 class="heading-light">Access Denied</h2>
                <div class="box-text">
                    <h4 class="heading-light">You are not authorized to access this page</h4>
                    <p class="text-light">Please Log In by clicking on the “<a href="./login-page.php" class="color-theme">Log In</a>” link to the right.</p>
